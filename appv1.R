    ...
    #Reading dataset (to propose the axis in UI, otherwise I can make it in reactiveplot)----
     ...
     #Making the Plot----
      ...
      #filtering regions and countries
        ...
        #creating the plot
        gg<-ggplot()+
        geom(data=dta1,mapping=aes(x=!!x, y=!!y, color=!!col), size=1/4)+ 
        geom(data=dta2,mapping=aes(x=!!x, y=!!z, color=!!col), size=1/4, linetype = "dashed")
